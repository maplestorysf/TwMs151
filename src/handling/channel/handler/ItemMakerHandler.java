        ...
        switch (craftID) {
            ...
            default:
                if ((ce.needOpenItem) && (chr.getSkillLevel(craftID) <= 0)) {
                    ...
                    if (!MapleInventoryManipulator.checkSpace(c, ((Integer) i.left), ((Integer) i.mid), "")) {
                        return;
                    }
                }   ce.reqItems.entrySet().forEach((e) -> {
                    ...
                    while (true) {
                        ...
                        for (Triple i : ce.targetItems) {
                            if (Randomizer.nextInt(100) < ((Integer) i.right)) {
                                ...
                                if (ce.needOpenItem) {
                                    ...
                                    if (mLevel == 1) {
                                        sa.put(ce, new SkillEntry(0, 0, SkillFactory.getDefaultSExpiry(ce)));
                                    } else if (mLevel > 1) {

...
public class CharacterTransfer implements Externalizable {
    ...
    public int reborns, apstorage, MSIPoints, clanId, pee, side;
    public boolean muted, autoToken, elf, debug;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.debug = chr.getDebugMessage();
        ...
        chr.getCharacterCard().getCards().entrySet().forEach((ii) -> {
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        this.antiMacro = (MapleLieDetector) in.readObject();

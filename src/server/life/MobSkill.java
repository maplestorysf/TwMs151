    ...
    public void applyEffect(MapleCharacter player, MapleMonster monster, boolean skill) {
        ...
        switch (skillId) {
            ...
            case 127:
                if (lt != null && rb != null && skill && monster != null && player != null) {
                    getPlayersInRange(monster, player).forEach((character) -> {
                        character.dispel();
                    });
                } else if (player != null) {
                    player.dispel();
                ...
                if (monster != null && monster.getMap().getSquadByMap() == null) { //not pb/vonleon map
                    ...
                    if (info != null) {
                        if (lt != null && rb != null && skill && player != null) {
                            getPlayersInRange(monster, player).stream().filter((chr) -> (!chr.hasBlockedInventory())).forEachOrdered((chr) -> {
        ...
        if (stats.size() > 0 && monster != null) {
            if (lt != null && rb != null && skill) {
                getObjectsInRange(monster, MapleMapObjectType.MONSTER).forEach((mons) -> {
        ...
        if (disease != null && player != null) {
            if (lt != null && rb != null && skill && monster != null) {
                getPlayersInRange(monster, player).forEach((chr) -> {

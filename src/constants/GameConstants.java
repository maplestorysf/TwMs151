...
public class GameConstants {
    ...
    private static final int[] exp = {
        ...
        1231492983, 1261492983, 1331492983, 1371492283, 1421492933, 1451492963, 1491492783, 1501492988, 1631492983, 1741492983,
        1851492983, 1961492983, 2071492983};
    ...
    public static int getExpNeededForLevelR(short level, int R) {
        if (R == 0) {
            R = 1;
        }
        if (level < 0 || level >= exp.length) {
    ...
    public static boolean isBandit(int job) {
        return job == 400 || (job >= 420 && job <= 422);
    }

    public static boolean isMage(int job) {
        return (job >= 200 && job <= 232) || (job >= 1200 && job <= 1212) || (job >= 3200 && job <= 3212);
    }

    public static boolean isOneHandedWarrior(int job) {
        return (job >= 100 && job <= 122) || (job >= 1100 && job <= 1112);
    }

    public static boolean isNightLord(int job) {
        return (job == 400) || (job >= 410 && job <= 412) || (job >= 1400 && job <= 1412);
    }

    public static boolean isSpearman(int job) {
        return (job >= 130 && job <= 132);
    }

    public static boolean isGunner(int job) {
        return job == 500 || (job >= 520 && job <= 522) || (job >= 3500 && job <= 3512);
    }
    ...
    public static boolean is職業特殊裝備(int itemid) {
        return (is控制器(itemid)) || (is靈魂手鐲(itemid)) || (is諾巴精髓(itemid)) || (is靈魂盾(itemid)) || (is惡魔獵手盾(itemid)) || (is米哈爾盾(itemid)) || (is龍傳寶盒(itemid)) || (is幻影卡片(itemid)) || (is雙刀副手(itemid));
    }

    public static boolean is雙刀副手(int itemId) {
        return itemId / 10000 == 134;
    }
    ...
    public static boolean is米哈爾盾(int itemId) {
        return (itemId >= 1098000) && (itemId <= 1098003);
    }

    public static boolean is惡魔獵手盾(int itemId) {
        return (itemId >= 1099000) && (itemId <= 1099009);
    }

    public static boolean is靈魂盾(int itemId) {
        return (itemId >= 1098000) && (itemId <= 1098003);
    }

    public static boolean is龍傳寶盒(int itemId) {
        return (itemId >= 1352300) && (itemId <= 1352304);
    }

    public static boolean is諾巴精髓(int itemId) {
        return (itemId >= 1352500) && (itemId <= 1352504);
    }

    public static boolean is靈魂手鐲(int itemId) {
    ...
    public static boolean canScroll(final int itemId) {
        ...
        if ((itemId < 1112534) || (itemId > 1112444)) {
            return true; //特殊戒指
        }
        if (is職業特殊裝備(itemId)) {
            return true; //特殊裝備
    ...
    public static boolean isAswanMap(int mapId) {
        return mapId >= 262021000 && mapId <= 262023130;
    }
    ...
    public static double getAttackRange(MapleCharacter chr, MapleStatEffect def) {
        int rangeInc = chr.getStat().defRange;
        double base = 400.0;
    ...
    public static boolean isIllegal(int itemId) {
        return itemId == 1004043 || itemId == 1004042 || itemId == 1004040;
    }
    ...
    public static int getAddAtkCount(int skillid) {
        int Add = 0;
        switch (skillid) {
            case 1211002:
                Add += 1;
    ...
    public static int getAddMobCount(int skillid) {
        int Add = 0;
        switch (skillid) {
            case 14101006:
                Add += 1;

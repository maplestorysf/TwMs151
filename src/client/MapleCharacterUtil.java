...
public class MapleCharacterUtil {
    ...
    public static boolean canCreateChar(final String name, final boolean gm) {
        return !(getIdByName(name) != -1 || !isEligibleCharName(name, gm) || name.toLowerCase().contains("Windy".toLowerCase()) || name.toLowerCase().contains("Lus".toLowerCase()));
    }

    public static boolean canpoop(final String name, final boolean gm) {
        return isEligibleCharName(name, gm);
    }

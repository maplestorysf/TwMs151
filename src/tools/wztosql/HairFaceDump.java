...
public class HairFaceDump {
    ...
    public static void main(String[] args) throws IOException {
        ...
        data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Character.wz/Hair"));
        ...
        if (maleHair1.isEmpty() || maleHair2.isEmpty() || maleHair3.isEmpty() || femaleHair1.isEmpty() || femaleHair2.isEmpty() || femaleHair3.isEmpty() || maleFace.isEmpty() || femaleFace.isEmpty()) {
            System.out.println("找不到任何 髮型/眼睛 .");//in an array
            System.exit(0);
            return;
        }
    ...
    public static boolean hairExists(int hair) {
        ...
        return root.getFiles().stream().map((topDir) -> Integer.parseInt(topDir.getName().substring(0, 8))).anyMatch((id) -> (id == hair));
    }

    public static boolean faceExists(int face) {
        MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("net.sf.odinms.wzpath") + "/Character.wz/Face"));
        final MapleDataDirectoryEntry root = data.getRoot();
        return root.getFiles().stream().map((topDir) -> Integer.parseInt(topDir.getName().substring(0, 8))).anyMatch((id) -> (id == face));
    }
    ...
    public static String createStyler(List<Integer> maleHair1, List<Integer> maleHair2, List<Integer> maleHair3, List<Integer> femaleHair1, List<Integer> femaleHair2, List<Integer> femaleHair3, List<Integer> maleFace, List<Integer> femaleFace, List<Integer> hairList, List<Integer> faceList) {
        ...
        addLine(sb, "   cm.sendSimple(\" 該是時候打扮打扮了 !\\r\\n#L0#膚色#l\\r\\n#L1#髮型1#l\" + (v13 == 0 ? ((\"\" + v7 != v9 ? \"\\r\\n#L2#髮型2#l\" : \"\") + (\"\" + v7 != v11 ? \"\\r\\n#L3#髮型3#l\" : \"\")) : ((\"\" + v8 != v10 ? \"\\r\\n#L2#髮型2#l\" : \"\") + (\"\" + v8 != v12 ? \"\\r\\n#L3#髮型3#l\" : \"\"))) + \"\\r\\n#L4#髮色#l\\r\\n#L5#眼睛#l\\r\\n#L6#眼精顏色#l\");");
        addLine(sb, "}");
        addLine(sb, "");
        ...
        addLine(sb, "   cm.sendStyle(\"選擇你最喜歡的\", v17);");
        addLine(sb, "}");
        addLine(sb, "");

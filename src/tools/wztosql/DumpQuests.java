...
public class DumpQuests {
    ...
    private static Thread t5 = null;
    private static Thread t6 = null;
    private static Thread t7 = null;
    ...
    public void dumpQuests(PreparedStatement psai, PreparedStatement psas, PreparedStatement psaq, PreparedStatement ps, PreparedStatement psr, PreparedStatement psq, PreparedStatement psa) throws Exception {
        if (!update) {
            ...
            System.out.println("刪除資料表 wz_questdata 的資料成功.");
        }
        ...
        System.out.println("讀取 wz_questdata.....");
        int uniqueid = 0;
        for (MapleData qz : checkz.getChildren()) { //requirements first
            ...
            System.out.println("讀取任務 : " + id);
        }
        System.out.println("寫入 wz_questdata... ");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("結束" + withErrors + " 花了 " + elapsedMinutes + " 分 " + elapsedSecs + " 秒");
    }
}
